...
import models.cifar100 as cifar100_models ##added by ffk 01/23/19
...
ALL_MODEL_NAMES = sorted(set(IMAGENET_MODEL_NAMES + CIFAR100_MODEL_NAMES + CIFAR10_MODEL_NAMES)) ##edited by ffk
...
def create_model(pretrained, dataset, arch, parallel=True, device_ids=None):
    ...
    elif dataset == 'cifar100': ##added by ffk
